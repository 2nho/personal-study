...
import kr.co.goodee39.ch10.service.Quiz101Service;
...
public class Quiz101Controller extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Quiz101Service service = new Quiz101Service();
		service.getCount(request);
		
		RequestDispatcher rdp = request.getRequestDispatcher("/ch10/quiz1_1.jsp");
